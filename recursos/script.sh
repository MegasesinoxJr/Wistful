...
run_and_report "download_default_profile_pic" "mkdir -p /srv/wistful/DJANGO_media/perfil/ && wget --user-agent='Mozilla/5.0' -O /srv/wistful/DJANGO_media/perfil/default.jpg https://i.imgur.com/Oh7J7GP.jpeg"
